...
static char rcsid[] = "$Id: b4soild.c  04/27/2010 Released by Tanvir Morshed $";
 ...
 * Modified by Larry Wagner, Calvin Bittner, Geoffrey Coram, Tanvir Morshed 04/27/2010 
 **********/
	...
	Vtm00= 0.026; 	/* v4.3.1 Vtm00 replaces hardcoded 0.026 -Tanvir */	
      ...
      /*dsqrtPhisExt_dT = dsqrtPhis_dT - T9 * (dVbsh_dT) */
       ...
       /*   need temperature derivs of Abulk & Abulk0  */
            ...
            dTL5_dT = -T13*dphi_dT/(phi + pParam->B4SOIketas);
            dTL6_dT = 0.5*T14*dTL5_dT/(1-T13);
