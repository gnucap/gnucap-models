...
FILE *fplog;
    ...
    if (fabs(model->BSIM4version - 4.81) > 0.0001){
            fprintf(fplog, "Warning: This model is BSIM4.8.1; you specified a wrong version number.\n");
            printf("Warning: This model is BSIM4.8.1; you specified a wrong version number.\n");
}
